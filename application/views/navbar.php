    ...
    <body>
        ...
        <div class="navbar nav navbar-default nav-justified navbar-fixed-top" role="navigation">
            <div class="container">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand navbar-name" href="<?php echo base_url('/home'); ?>"><span></span> HOME</a>
                </div>
                ...
                <div class="navbar-collapse collapse">
                        ...
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle navbar-name"  data-toggle="dropdown"><span></span> SETTINGS<span class="caret"></span></a>
